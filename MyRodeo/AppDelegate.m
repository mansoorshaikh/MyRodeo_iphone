...
@synthesize hvc,isfromLookup,currentlocation,isLandscapeOK,currentRodeo,eventsList,isSaved;
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    MainNavigationController *navController = [[MainNavigationController alloc] initWithRootViewController:hvc];
